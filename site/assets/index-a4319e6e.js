...
init({});
__vitePreload(() => import('./scenes.html-f9f4db31.js'),true?[]:void 0)
...
__vitePreload(() => import('./module-dbd084dc.js'),true?[]:void 0)
          .then((mod) => register(mod, "Kram_ff9911dd_events", "js", null));
