...
var Provider = class Provider extends HTMLElement {
	...
	constructor(init, label) {
		...
		this.context = new require_effects.Context(init);
...
var Observer = class {
	...
	attachObserver(fn) {
		const init = this.provider.attach((ev) => {
			...
			const effect = new require_effects.DirectEffect(fn, {
				property,
				value
			});
			if (this.observed) {
...
Object.defineProperty(exports, "FromService", {
	enumerable: true,
	get: function() {
		return FromService;
	}
...
Object.defineProperty(exports, "fromAuth", {
	enumerable: true,
	get: function() {
		return fromAuth;
	}
