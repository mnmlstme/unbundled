...
<p class="custom-rotation" style="--from-direction: var(--direction-sw)">
  “What’s happened to me?” he thought. It wasn’t a dream. His room, a proper
  human room although a little too small, lay peacefully between its four
  familiar walls.
</p>
...
<p class="custom-options" data-color-option="sky">
  ...
  at home, and on top of that there’s the curse of travelling, worries about
  making train connections, bad and irregular food, contact with different
